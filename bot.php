<?php 
define('BOT_TOKEN', '1453585831:AAE_14qvIgj8vO6PhNgfkE2IFJ9nnDqI_MM'); 
...
function processaCallbackQuery($callback){
  $BOT_TOKEN = "1453585831:AAE_14qvIgj8vO6PhNgfkE2IFJ9nnDqI_MM";
...
*Escolha uma das opções a baixo e clique no botão correspondente.*',
		    'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'➕ Adicione-me a um grupo ➕','url'=>'https://t.me/MkConsultasBot?startgroup=start')                                            
                                                      ),
                                                     //linha 2
                                                     array(                                            
                                                     ...
                                                     //linha 5
                                                     array(                        
                                                         array('text'=>'Grupo Oficial Do Bot','url'=>'http://t.me/consultasmk')                                                  
...
*Escolha uma das opções a baixo e clique no botão correspondente.*',
		    'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                     ...
                                                     array(                                            
													  ...
													  //linha 3
                                                     array(                                            
                                                         array('text'=>'☸ Geradores ',"callback_data"=>'check')
													  ),
                                                     //linha 4
                                                     array(                                                                                                               
                                                         array('text'=>'💎 Planos 💎',"callback_data"=>'queroservip')//botão com callback 
       ...
       if($data_array['id']==$callback['from']['id']) {  
          ...
          if(!stripos($adms, "MkConsultasBot")) {         
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                                                                                    
       ...
       apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => '🔍 *MENU DE CHECKERS*',
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'CC',"callback_data"=>'consultacc'), //botão 1                                              
                                                      ),
													  //linha 2
                                                     array(
                                                         array('text'=>'Combate',"callback_data"=>'consultacombate'), //botão 2 
                                                      ),
													  //linha 3
                                                     array(
                                                         array('text'=>'Globosat',"callback_data"=>'consultaglobosat'), //botão 2                                              
                                                      ),
													  //linha 4
                                                     array(
                                                         array('text'=>'Premiere',"callback_data"=>'consultapremiere'), //botão 3  
													  ),
													  //linha 5
                                                     array(
                                                         array('text'=>'Sexyhot',"callback_data"=>'consultasexyhot'), //botão 3
                                                      ),
													  //linha 5
                                                     array(
                                                         array('text'=>'Telecine',"callback_data"=>'consultatelecine'), //botão 3
													  ),
													 array(
	...
	} else if ($data == 'consultacc') {
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "*🔍 CHECKER VIP 🔍*
━━━━━━━━━━━━━━━━━━
*╭──────────────
┇   〘  CHECKER CC  〙
╰──────────────*
*Testador de Cartoes de credito ou Debito Gerados, testa a validade do cartao e obtem os detalhes do emissor (como onde ele esta localizado) e os detalhes do cartao (como tipo, a bandeira ea categoria)*
...
'reply_markup' => array('inline_keyboard' => array(                                                                     
                                                      //linha 1
                                                     array(
                                                         array('text'=>'🔙  Voltar  🔙',"callback_data"=>'checkers'), //botão 1                                              
                                                      )
                                                          
                                            )
                                    )));
	
	} else if ($data == 'consultacombate') {
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "*🔍 CHECKER VIP 🔍*
━━━━━━━━━━━━━━━━━━
*╭──────────────
┇   〘  CHECKER COMBATE  〙
╰──────────────*
*Para utilizar o checker, voce precisa digitar o comando seguido de email e senha*

*Formato: Email/Senha*

*Exemplo:*
`/combate cassio@gmail.com|123456`
━━━━━━━━━━━━━━━━━━",
...
*Exemplo:*
`/globosat cassio@gmail.com|123456`
━━━━━━━━━━━━━━━━━━",
...
*Exemplo:*
`/premiere cassio@gmail.com|123456`
━━━━━━━━━━━━━━━━━━",
...
*Exemplo:*
`/sexyhot cassio@gmail.com|123456`
━━━━━━━━━━━━━━━━━━",
...
*Exemplo:*
`/telecine cassio@gmail.com|123456`
━━━━━━━━━━━━━━━━━━",
...
'reply_markup' => array('inline_keyboard' => array(                                                                     
    ...
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => '🔍 *MENU DE CONSULTA*',
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'Consulta CPF',"callback_data"=>'consultascpf'), //botão 1                                              
                                                      ),
													  //linha 2
                                                     array(
                                                         array('text'=>'Consulta CPF2',"callback_data"=>'consultascpf2'), //botão 2 
                                                      ),
													  //linha 3
                                                     array(
                                                         array('text'=>'Consulta TELEFONE',"callback_data"=>'consultastel'), //botão 2                                              
                                                      ),
													  //linha 4
                                                     array(
                                                         array('text'=>'Consulta NOME',"callback_data"=>'consultasnome'), //botão 3  
													  ),
													  //linha 5
                                                     array(
                                                         array('text'=>'Consulta PLACA',"callback_data"=>'consultasplaca'), //botão 3
													  ),
													  //linha 6
                                                     array(
                                                         array('text'=>'Consulta CEP',"callback_data"=>'consultascep'), //botão 3  
													  ),
													  //linha 7
                                                     array(
                                                         array('text'=>'Consulta VIZINHOS',"callback_data"=>'consultasvizinhos'), //botão 3
													  ),
													  //linha 8
                                                     array(
                                                         array('text'=>'Consulta IP',"callback_data"=>'consultaip'), //botão 3													  
                                                      ),
													  //linha 8
                                                     array(
                                                         array('text'=>'Consulta SITE',"callback_data"=>'consultasite'), //botão 3													  
                                                      ),
													 array(
                                                         array('text'=>'🔙  Voltar  🔙',"callback_data"=>'menu'), //botão 1                                              
                                                      )
	...
	} else if ($data == 'consultastel') {
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "*🔍 CONSULTA VIP 🔍*
━━━━━━━━━━━━━━━━━━
*╭──────────────
┇   〘  CONSULTA TEL  〙
╰──────────────*
*Você precisa digitar o Comando e em seguida digitar o DDD + NÚMERO.*

*TELEFONE SHIFT:* `/tel1`
*TELEFONE TARGET:* `/tel2`
...
'reply_markup' => array('inline_keyboard' => array(                                                                     
    ...
    } else if ($data == 'consultasnome') {
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "*🔍 CONSULTA VIP 🔍*
━━━━━━━━━━━━━━━━━━
*╭──────────────
┇   〘  CONSULTA NOME  〙
╰──────────────*
*Você precisa digitar o comando e em seguida digitar o NOME.*

*Exemplo:*

`/nome Luis Henrique Silva`
━━━━━━━━━━━━━━━━━━",
...
'reply_markup' => array('inline_keyboard' => array(                                                                     
    ...
    } else if ($data == 'consultascep') {
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "*🔍 CONSULTA VIP 🔍*
━━━━━━━━━━━━━━━━━━
*╭──────────────
┇   〘  CONSULTA CEP  〙
╰──────────────*
*Você precisa digitar o comando e em seguida, digitar os 8 NÚMERO DO CEP.*
...
'reply_markup' => array('inline_keyboard' => array(                                                                     
	...
	} else if ($data == 'consultasvizinhos') {
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "*🔍 CONSULTA VIP 🔍*
━━━━━━━━━━━━━━━━━━
*╭──────────────
┇   〘  CONSULTA VIZINHOS  〙
╰──────────────*
*Você precisa digitar o comando e em seguida, digitar os 11 NÚMERO DO CPF.*

*Exemplo:*

`/vizinhos 91988422554`
━━━━━━━━━━━━━━━━━━",
...
'reply_markup' => array('inline_keyboard' => array(                                                                     
	...
	} else if ($data == 'consultasplaca') {
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "*🔍 CONSULTA VIP 🔍*
━━━━━━━━━━━━━━━━━━
*╭──────────────
┇   〘  CONSULTA PLACA  〙
╰──────────────*
*Você precisa digitar o comando e em seguida digitar a PLACA. *
...
'reply_markup' => array('inline_keyboard' => array(                                                                     
	...
	} else if ($data == 'consultaip') {
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "*🔍 CONSULTA VIP 🔍*
━━━━━━━━━━━━━━━━━━
*╭──────────────
┇   〘  CONSULTA IP  〙
╰──────────────*
*Você precisa digitar o comando e em seguida, digitar o IP do portador.*
...
'reply_markup' => array('inline_keyboard' => array(                                                                     
	...
	} else if ($data == 'consultasite') {
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => "*🔍 CONSULTA VIP 🔍*
━━━━━━━━━━━━━━━━━━
*╭──────────────
┇   〘  CONSULTA SITE  〙
╰──────────────*
*Você precisa digitar o comando e em seguida, digitar o SITE do portador.*
...
'reply_markup' => array('inline_keyboard' => array(                                                                     
  ...
  } else if ($data == 'autorizados') {
    apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => '*⚜ QUERO ACESSO VIP ⚜*',
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                                                                                    
                                                       //linha 1
                                                     array(
                                                         array('text'=>'✅ COMPRAR ACESSO VIP ✅','url'=>'http://t.me/MaikinBr'), //botão 1                                              
                                                      ),
                                                      //linha 2
                                                     array(
                                                         array('text'=>'💎 Planos 💎',"callback_data"=>'queroservip')//botão com callback                                            
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                                                                                   
                                                     ...
                                                     array(
                                                      ...
                                                      //linha 2
                                                     array(
                                                         array('text'=>'🔙  Voltar  🔙',"callback_data"=>'queroservip')//botão com callback                                               
                                                      )
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
      ...
      apiRequest("editMessageText", array('chat_id' => $chat_id, 'message_id' => $message_id, "parse_mode" => "Markdown", "text" => '🔍 *MENU DE GERADORES*',
'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'CPF',"callback_data"=>'AKI'), //botão 1                                              
                                                      ),
													  //linha 2
                                                     array(
                                                         array('text'=>'Bancarias',"callback_data"=>'AKI'), //botão 2 
                                                      ),
													  //linha 3
                                                     array(
                                                         array('text'=>'Pessoas',"callback_data"=>'AKI'), //botão 2                                              
                                                      ),
													  //linha 4
                                                     array(
                                                         array('text'=>'Empresas',"callback_data"=>'AKI'), //botão 3  
													  ),
													 array(
                                                         array('text'=>'🔙  Voltar  🔙',"callback_data"=>'menu'), //botão 1                                              
                                                      )
...
Conheça abaixo, todos os meus comandos:*', "reply_to_message_id" => $message_id,
         ...
         } else if($member_user == 'MkConsultasBot') {
...
Para utilizar todas as minhas ferramentas você precisa me colocar como administrador 😉*',
    ...
    if (isset($message['text'])) {
	    ...
	    $verifica = substr(strtoupper($text), 0,9) == '/NUMERO';
            ...
            if($login){
               ...
               include("botcon/numero.php");
                ...
                if($type == 'private') {
                    ...
                    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => '*Telefone Target*
*Consulta Completa Base Target*
...
*Exemplo:*
`/numero 21978216181`", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'🗑  Apagar  🗑',"callback_data"=>'apagar')//botão com callback                                                   
        ...
        $verifica = substr(strtoupper($text), 0,9) == '/CNH';
            ...
            if($login){
               ...
               include("botcon/cnhdetran.php");
                ...
                if($type == 'private') {
                    ...
                    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => '*CNH Checker* - _Consulta de CNH, obtém informações sobre o portador da CNH.
...
`/cnh 27867260854`',
   'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                   ...
                   apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "*CNH Checker* - __Consulta de CNH, obtém informações sobre o portador da CNH.
...
`/cnh 27867260854`", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'🗑  Apagar  🗑',"callback_data"=>'apagar')//botão com callback                                                   
            ...
            if($login){
               ...
               include("botcon/cpf2.php");
                ...
                if($type == 'private') {
                    ...
                    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => '*CPF Checker* - _Consulta completa de CPF, obtém todos os dados do portador.
...
`/cpf2 05104716414`", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'🗑  Apagar  🗑',"callback_data"=>'apagar')//botão com callback                                                   
...
`[/cpf1 05104716414]`", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'🚮  Apagar  🚮',"callback_data"=>'apagar')//botão com callback                                                   
            ...
            if($login){                         
               ...
               include("botcon/nome.php");
                ...
                if($type == 'private') {
                    ...
                    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => '*NOME Checker* - _Consulta simples de Nome, obtém os dados do portador._
...
`[/nome Jacinto Pinto`]',
   'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                   ...
                   apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "*TELEFONE Checker* - _Consulta simples de Nome, obtém os dados do portador._

`[/nome Jacinto Pinto]`", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'🚮  Apagar  🚮',"callback_data"=>'apagar')//botão com callback                                                   
...
$verifica = substr(strtoupper($text), 0,5) == '/TEL1';
            ...
            if($login){
               ...
               include("botcon/telefone.php");
                ...
                if($type == 'private') {
                    ...
                    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => '*TELEFONE Checker* - _Consulta Completa de telefone, obtém os dados do portador._
...
`[/tel 21987822456]`", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'🚮  Apagar  🚮',"callback_data"=>'apagar')//botão com callback                                                   
...
$verifica = substr(strtoupper($text), 0,5) == '/TEL2';
        ...
        if($verifica){
            ...
            if($login){
               ...
               include("botcon/telefone2.php");
                                                             
            }else{
                
                if($type == 'private') {
	                 
                    apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => '*TELEFONE Target* - _Consulta Completa de telefone, obtém os dados do portador._
...
`[/tel2 21987822456`]',
   'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                   ...
                   apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "*TELEFONE Target* - _Consulta simples de Nome, obtém os dados do portador._

`[/tel2 21987822456]`", "reply_to_message_id" => $message_id,
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'🚮  Apagar  🚮',"callback_data"=>'apagar')//botão com callback                                                   
...
`[/placa1 JJK1960]`", "reply_to_message_id" => $message_id,
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                                                      //linha 1
                                                     array(
                                                         array('text'=>'🚮  Apagar  🚮',"callback_data"=>'apagar')//botão com callback                                                              
...
'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
		...
		if(strpos($text, "/tel1") !== false || strpos($text, "/Tel1") !== false || strpos($text, "/TEL1") !== false){
                   ...
                   for($i=0;$i<count($array_usuarios);$i++){
                    ...
                    if($continuar){
                        ...
                        if($type == 'private') {
                           ...
                           apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "📁 *INFORMAÇÕES DE STATUS*
*━━━━━━━━━━━━━━━━━*
*✅ Status Ativo*
*━━━━━━━━━━━━━━━━━*
*🧑🏻:* $first_name
...
*━━━━━━━━━━━━━━━━━*", "reply_to_message_id" => $message_id,
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                       ...
                       if($type == 'private') {apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "📁 *INFORMAÇÕES DE REVENDEDORES*
*━━━━━━━━━━━━━━━━━*
...
*━━━━━━━━━━━━━━━━━*",
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                            ...
                            apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "📁 *INFORMAÇÕES DE REVENDEDORES*
*━━━━━━━━━━━━━━━━━*
*Revendedores Oficiais*
*━━━━━━━━━━━━━━━━━*
*🧑Ola:* $first_name
...
*━━━━━━━━━━━━━━━━━*", "reply_to_message_id" => $message_id,
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
		...
		if(strpos($text, "/rev") !== false || strpos($text, "/Rev") !== false || strpos($text, "/REV") !== false){
                   ...
                   for($i=0;$i<count($array_grupos);$i++){
                    ...
                    $converte_dt = explode("/", $vencimento2[0]);
                    $c_ano = $converte_dt[0];
                    $c_mes = $converte_dt[1];
                    $c_dia = $converte_dt[2];
                    ...
                    if($continuar2){
                        $vencimento2 = "$c_dia/$c_mes/$c_ano - $vencimento2[1]";
...
*━━━━━━━━━━━━━━━━━*","reply_to_message_id" => $message_id,
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                       ...
                       if($type == 'private') {apiRequest("sendMessage", array('chat_id' => $chat_id, "parse_mode" => "Markdown", "text" => "📁 *INFORMAÇÕES DE STATUS*
*━━━━━━━━━━━━━━━━━*
*✅ SRevendedores*
*━━━━━━━━━━━━━━━━━*
*Ola:* $first_name
...
define('WEBHOOK_URL', 'https://api.telegram.org/1453585831:AAE_14qvIgj8vO6PhNgfkE2IFJ9nnDqI_MM/setwebhook?url=https://mkbuscas.com/bot.php');
